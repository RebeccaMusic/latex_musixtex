...
%Example enviroment. 
%Ref: ph0t0nix, user202729, "Verbatim environment that can break long lines?", https://tex.stackexchange.com/questions/14342/verbatim-environment-that-can-break-long-lines
%The fancyvrb package in combination with the fvextra package allows you to use linebreaks in the Verbatim environment by specifying the breaklines=true option.--ph0t0nix
\usepackage{fancyvrb-ex}
\usepackage{fvextra}
\fvset{breaklines=true}
\fvset{breakanywhere=true}%這樣URL可以換行
